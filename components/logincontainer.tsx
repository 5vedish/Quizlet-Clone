    ...
    return (
        <div className="flex text-blue-500 bg-white bg-opacity-30 w-80 h-72 m-auto border-black border border-opacity-20 rounded-xl font-semibold">
            <label className="m-6 ml-9">
                Username
                <input className="bg-white m-2 -ml-2 w-64 h-10 border border-gray rounded-md placeholder-gray-400 focus:placeholder-gray-200" placeholder="Enter Username">
                </input>
                <label className="m-6 -ml-0">
                    Password
                    <input className="bg-white m-2 -ml-2 w-64 h-10 border border-gray rounded-md placeholder-gray-400 focus:placeholder-gray-200" placeholder="Enter Password">
                    </input>
                </label>

...
export default function SignupCard() {
  return (
    <>
      ...
      <div
        className="flex flex-col text-blue-500 w-96 h-96 m-20 bg-white bg-opacity-30 rounded-xl
      ...
      >
        ...
        <button
          className="font-semibold text-align-center w-20 h-10 text-white 
                    ...
                    hover:from-purple-400 hover:via-indigo-400 hover:to-blue-300 mt-4 ml-6 mb-4
